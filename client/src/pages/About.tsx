          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-[1.2fr_1fr] gap-10 lg:gap-16 items-start mb-12 sm:mb-16">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.label} className="surface-elite px-6 py-5 flex items-center justify-between border border-white/10 bg-slate-950/70 backdrop-blur-xl shadow-[0_24px_80px_rgba(0,0,0,0.4)]">
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              {principles.map((principle) => (
                <div key={principle.title} className="surface-elite p-6 sm:p-8 border border-white/10 bg-slate-950/70 backdrop-blur-xl shadow-[0_24px_80px_rgba(0,0,0,0.4)]">
                  <div className="text-lg sm:text-xl font-black text-white mb-2">{principle.title}</div>
                  <p className="text-slate-300 text-sm sm:text-base font-light leading-relaxed">{principle.description}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={item.title} className="surface-elite p-6 sm:p-8 border border-white/10 bg-slate-950/70 backdrop-blur-xl shadow-[0_24px_80px_rgba(0,0,0,0.4)]">
                  ...
                  <p className="text-slate-300 text-sm sm:text-base font-light leading-relaxed">{item.text}</p>
                </div>
              ))}
            </div>
