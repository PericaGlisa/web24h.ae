      ...
      <main>
          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start mb-12 sm:mb-16">
              ...
              <div className="flex flex-wrap gap-3">
                {signals.map((signal) => (
                  <div key={signal.label} className="surface-elite px-5 py-4 flex items-center gap-3 shadow-[0_18px_70px_rgba(0,0,0,0.35)]">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {pillars.map((pillar) => (
                <div key={pillar.title} className="surface-elite p-6 sm:p-8 border border-white/10 bg-slate-950/70 backdrop-blur-xl shadow-[0_28px_90px_rgba(0,0,0,0.45)]">
        ...
        <section className="py-20 sm:py-28 bg-slate-950">
          <div className="container mx-auto px-6">
            ...
            <div className="mt-12 sm:mt-16 surface-elite p-6 sm:p-8 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 border border-white/10 bg-slate-950/70 backdrop-blur-xl shadow-[0_30px_100px_rgba(0,0,0,0.45)]">
              <div>
                ...
                <p className="text-slate-300 text-sm sm:text-base font-light leading-relaxed mt-2 max-w-2xl">
                  We build with React, TypeScript, and high-performance tooling to ensure speed and long-term flexibility.
                </p>
              </div>
              <div className="flex flex-wrap gap-3 text-[10px] sm:text-[11px] font-bold tracking-[0.25em] text-slate-400">
                {["React", "TypeScript", "Tailwind", "Vite", "Node", "Analytics"].map((tool) => (
                  <span key={tool} className="px-3 py-2 rounded-full border border-white/10 bg-white/5 text-white backdrop-blur-xl">
                    {tool}
                  </span>
                ))}
              </div>
