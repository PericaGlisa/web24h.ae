        ...
        <section className="py-20 sm:py-28 bg-background">
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-4 gap-6">
              {phases.map((phase) => (
                <div key={phase.title} className="surface-elite p-6 sm:p-7">
                  ...
                  <p className="text-slate-400 text-sm sm:text-base font-light leading-relaxed mb-4">{phase.description}</p>
